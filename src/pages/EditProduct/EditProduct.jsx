...
const EditProduct = () => {
    ...
    const editProduct = async (e)=>{
        e.preventDefault()
        const response = await axios.put( "https://653b2d832e42fd0d54d4c34c.mockapi.io/products/"  + id,product )
    ...
    const fetchProduct  = async()=>{
        const response = await axios.get( "https://653b2d832e42fd0d54d4c34c.mockapi.io/products/"  + id)
